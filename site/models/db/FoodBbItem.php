...
class FoodBbItem extends Programster\MysqlObjects\AbstractTableRowObject implements JsonSerializable, FoodItemInterface
{
    protected $m_barcode;
    ...
    {
        return FoodBbTable::getInstance();
    }
    ...
    public function getSource() { return 3; }
}
